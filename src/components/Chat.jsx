      ...
      {conversation ? (
        <div className="flex-1 w-full  ">
          ...
          >
            <div className="flex items-center">
              {isMobile && (
                <button
                  onClick={onBack}
                  className="p-2 mr-2 text-[#aebac1] hover:text-white focus:outline-none"
                >
                  <svg
          ...
          >
            ...
            {/* Message Input */}
            <div className="sticky bottom-0 bg-[#202c33] w-full z-20">
        ...
        <div className="flex-1 flex items-center justify-center bg-[#222e35]">
          <div className="text-center p-6">
            ...
            <h2 className="text-3xl font-light text-[#e9edef] mb-2">
              WhatsApp Web
            </h2>
