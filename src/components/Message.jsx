...
const Message = ({ message, onDelete }) => {
  ...
  const renderStatusIcon = () => {
    ...
    switch (message.status) {
      case 'sent':
        return (
          <svg className="w-3.5 h-3.5 text-[#8696a0] ml-1" viewBox="0 0 16 15" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
      ...
      case 'read':
        return (
          <svg className="w-3.5 h-3.5 text-[#53bdeb] ml-1" viewBox="0 0 16 15" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
            <path d="M15.01 3.316l-.478-.372a.365.365 0 0 0-.51.063L8.666 9.879a.32.32 0 0 1-.484.033l-.358-.325a.319.319 0 0 0-.484.032l-.378.483a.418.418 0 0 0 .036.541l1.32 1.266c.143.14.36.12.486-.034l6.272-8.048a.366.366 0 0 0-.064-.512zm-4.1 0l-.478-.372a.365.365 0 0 0-.51.063L4.566 9.879a.32.32 0 0 1-.484.033L1.891 7.769a.366.366 0 0 0-.515.006l-.423.433a.364.364 0 0 0 .006.514l3.258 3.185c.143.14.361.125.484-.033l6.272-8.048a.365.365 0 0 0-.063-.51z" />
          </svg>
        );
      case 'failed':
        return (
          <svg className="w-3.5 h-3.5 text-red-500 ml-1" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      ...
      case 'location':
        return (
          <div>
            ...
            {message.content.address && <p className="text-sm">{message.content.address}</p>}
            <a 
  ...
  return (
    <div 
      className={`group flex mb-2 ${isOutgoing ? 'justify-end' : 'justify-start'}`}
    >
      <div 
